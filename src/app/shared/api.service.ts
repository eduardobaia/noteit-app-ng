...
export class ApiService {
  ...
  private SEND_FEEDBACK_URL = `${this.BASE_URL}\\feedbackl`;
  private SAVE_UPDATE_NOTEBBOK = `${this.BASE_URL}\\notebooks`; 
  private DELETE_NOTEBOOK_URL = `${this.BASE_URL}\\notebooks\\`; 
  constructor(private http: HttpClient) { 

  }

  //here do not subcribe. just return a observable :) 
  ...
  postNotebook(notebook: Notebook): Observable<Notebook>{
    return this.http.post<Notebook>(this.SAVE_UPDATE_NOTEBBOK, notebook);
  }
